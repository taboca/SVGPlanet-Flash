...
public class ExtendAssignmentCountHITHandler extends BaseHITHandler {

    //-------------------------------------------------------------
    // Variables - Private
    //-------------------------------------------------------------

    private int assignmentIncrement;
     ...
     *
     */
    public ExtendAssignmentCountHITHandler() {
    }
    ...
    public void handleHIT(ReviewableHIT reviewableHIT)
        ...
        try {
            requesterService.addAssignmentsToHIT(reviewableHIT.getId(),
                                                 assignmentIncrement);
    ...
    public void setAssignmentIncrement(int assignmentIncrement) {
        this.assignmentIncrement = assignmentIncrement;
    }
}
