...
public class ExtendDurationHITHandler extends BaseHITHandler {

    //-------------------------------------------------------------
    // Variables - Private
    //-------------------------------------------------------------

    private long additionalTimeInSeconds;
     ...
     *
     */
    public ExtendDurationHITHandler() {
    }


    //-------------------------------------------------------------
    // Implementation - BaseHITHandler
    //-------------------------------------------------------------

    public void handleHIT(ReviewableHIT reviewableHIT)
            throws HITHandlerException {
        try {
            requesterService.extendHITDuration(reviewableHIT.getId(),
                                               additionalTimeInSeconds);
        } catch (ServiceException e) {
            throw new HITHandlerException("Unable to extend HIT's duration: "
                                          + reviewableHIT.getId(), e);
        }
    }
    ...
    public void setAdditionalTimeInSeconds(long additionalTimeInSeconds) {
        this.additionalTimeInSeconds = additionalTimeInSeconds;
    }
}
