...
<title>28.1.1 RExec Objects </title>
</head>
<body>
...
<tr>
<td class='online-navigation'><a rel="prev" title="28.1 rexec  "
...
<td class='online-navigation'><a rel="next" title="28.1.2 defining restricted environments"
...
<a class="sectref" rel="prev" href="module-rexec.html">28.1 rexec  </a>
<b class="navlabel">Up:</b>
<a class="sectref" rel="parent" href="module-rexec.html">28.1 rexec  </a>
<b class="navlabel">Next:</b>
<a class="sectref" rel="next" href="rexec-extension.html">28.1.2 Defining restricted environments</a>
</div>
<hr /></div>
</div>
<!--End of Navigation Panel-->

<h2><a name="SECTION0030110000000000000000"></a><a name="rexec-objects"></a>
<br>
...
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5332' xml:id='l2h-5332' class="method">r_eval</tt></b>(</nobr></td>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5333' xml:id='l2h-5333' class="method">r_exec</tt></b>(</nobr></td>
  <td><var>code</var>)</td></tr></table></dt>
<dd>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5334' xml:id='l2h-5334' class="method">r_execfile</tt></b>(</nobr></td>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5335' xml:id='l2h-5335' class="method">s_eval</tt></b>(</nobr></td>
  <td><var>code</var>)</td></tr></table></dt>
<dd>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5336' xml:id='l2h-5336' class="method">s_exec</tt></b>(</nobr></td>
  <td><var>code</var>)</td></tr></table></dt>
<dd>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5337' xml:id='l2h-5337' class="method">s_execfile</tt></b>(</nobr></td>
  <td><var>code</var>)</td></tr></table></dt>
<dd>
Execute the Python code contained in the file <var>filename</var> in the
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5338' xml:id='l2h-5338' class="method">r_import</tt></b>(</nobr></td>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5339' xml:id='l2h-5339' class="method">r_open</tt></b>(</nobr></td>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5340' xml:id='l2h-5340' class="method">r_reload</tt></b>(</nobr></td>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5341' xml:id='l2h-5341' class="method">r_unload</tt></b>(</nobr></td>
  <td><var>module</var>)</td></tr></table></dt>
<dd>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5342' xml:id='l2h-5342' class="method">s_import</tt></b>(</nobr></td>
  <td><var>modulename</var><big>[</big><var>, globals</var><big>[</big><var>,
                             locals</var><big>[</big><var>, fromlist</var><big>]</big><var></var><big>]</big><var></var><big>]</big><var></var>)</td></tr></table></dt>
<dd>
Import the module <var>modulename</var>, raising an <tt class="exception">ImportError</tt>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5343' xml:id='l2h-5343' class="method">s_reload</tt></b>(</nobr></td>
  <td><var>module</var>)</td></tr></table></dt>
<dd>
Reload the module object <var>module</var>, re-parsing and re-initializing it.  
</dl>
...
<p>
<dl><dt><table cellpadding="0" cellspacing="0"><tr valign="baseline">
  <td><nobr><b><tt id='l2h-5344' xml:id='l2h-5344' class="method">s_unload</tt></b>(</nobr></td>
  <td><var>module</var>)</td></tr></table></dt>
<dd>
...
<a class="sectref" rel="parent" href="module-rexec.html">28.1 rexec  </a>
<b class="navlabel">Next:</b>
<a class="sectref" rel="next" href="rexec-extension.html">28.1.2 Defining restric